    ...
    <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-muted">Step {step} of 3</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="phoneNumber" className="block text-sm font-medium text-muted">
                  Phone Number
                </label>
                <input
              ...
              <div>
                <label htmlFor="dateOfBirth" className="block text-sm font-medium text-muted">
                  Date of Birth
                </label>
                <input
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div>
                <label htmlFor="ssn" className="block text-sm font-medium text-muted">
              ...
              <div>
                <label htmlFor="address" className="block text-sm font-medium text-muted">
                  Street Address
                </label>
                <input
              ...
              <div className="grid grid-cols-6 gap-4">
                ...
                <div className="col-span-2">
                  <label htmlFor="zipCode" className="block text-sm font-medium text-muted">
                    ZIP Code
                  </label>
                  <input
                    {...register("zipCode", {
          ...
          <div className="flex justify-between">
            {step > 1 && (
              <button
                type="button"
                onClick={prevStep}
                className="px-4 py-2 border border-border rounded-md shadow-sm text-sm font-medium text-foreground bg-surface hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                Previous
              </button>
            )}
